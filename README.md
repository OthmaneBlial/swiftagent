...
The v0.3 release ships the migrated Claude Code adapter and the agent-neutral extension boundary. Codex, OpenCode, ACP, and a conservative generic-command adapter are tracked as verified deliverables in [ROADMAP.md](ROADMAP.md); they are not presented as working until their own fixtures and live matrix pass.
